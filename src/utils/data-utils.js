...
export async function fetchSwiggyData(){
   ...
   const fetchedResp = await fetch("https://www.swiggy.com/dapi/restaurants/list/v5?lat=17.4434345&lng=78.3745776&is-seo-homepage-enabled=true&page_type=DESKTOP_WEB_LISTING", requestOptions);
