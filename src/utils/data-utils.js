...
export async function fetchRestaurantDetails(resId){
    ...
    const myHeaders = new Headers();
        ...
        myHeaders.append("content-type", "application/json");
        myHeaders.append("cookie", "_gcl_au=1.1.807413435.1725886286; _fbp=fb.1.1725886287182.971066150976299135; __SW=06uUdX3r1ZwjDZ4JUZjBd3ZzlE1t5heg; _device_id=96a519ef-4836-881a-ee36-9640e3e3197b; _session_tid=616655cc8158aafd437675c4904f7b0cd9da86ad840135fc3749eb3cd0f79fad774155af4fe19ac7d32327cdef15686d9d84353d4042576b99053a06ac3c839be11ef55315bc9ffa315204e459f4023c9098be0ed6555323772479e0c243fb59cddc922cd61528dacf91e0798e4c4011; _ga_8N8XRG907L=GS1.1.1725886287.1.1.1725887071.0.0.0; adl=true; _is_logged_in=1; _sid=gqme8c72-d723-4d9c-aabe-4bf72fc1486d; fontsLoaded=1; _gid=GA1.2.110185017.1729271734; userLocation={%22lat%22:%2217.503629470788848%22%2C%22lng%22:%2278.41291170567274%22%2C%22address%22:%222nd%20Phase%2C%20Allwyn%20Colony%2C%20Kukatpally%2C%20Hyderabad%2C%20Telangana%20500072%2C%20India%22%2C%22area%22:%22%22%2C%22showUserDefaultAddressHint%22:false}; _ga_34JYJ0BCRN=GS1.1.1729271734.13.1.1729271752.0.0.0; _ga=GA1.2.79792606.1725886287; _gat_0=1; _device_id=96a519ef-4836-881a-ee36-9640e3e3197b; _is_logged_in=1");
        myHeaders.append("priority", "u=1, i");
        myHeaders.append("referer", "https://www.swiggy.com/city/hyderabad/paradise-biryani-kukatpally-rest1854");
        myHeaders.append("sec-ch-ua", "\"Google Chrome\";v=\"129\", \"Not=A?Brand\";v=\"8\", \"Chromium\";v=\"129\"");
        myHeaders.append("sec-ch-ua-mobile", "?0");
        myHeaders.append("sec-ch-ua-platform", "\"macOS\"");
        myHeaders.append("sec-fetch-dest", "empty");
